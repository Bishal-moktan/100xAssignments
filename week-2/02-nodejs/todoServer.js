/**
  ...
  5. DELETE /todos/:id - Delete a todo item by ID
    ...
    - For any o``ther route not defined in the server return 404
...
app.post('/todos', (req, res) => {
  ...
  todos.push({ title, description, completed, id: id });
...
app.put('/todos/:id', (req, res) => {
  ...
  res.status(200).send('the todo item was found and updated');
});
